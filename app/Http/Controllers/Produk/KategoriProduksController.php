...
class KategoriProduksController extends Controller
{
    ...
    public function create()
    {
        ...
        $create_edit='create';
        $action_url=url('/kategori_produks');
        $include_form='produks.kategori_produks.form_kategori_produk';
        return view('crud.open_record', compact('kategori_produk','title','create_edit','action_url','include_form'));
    }
    ...
    public function edit(Kategori_produk $kategori_produk)
    {
        ...
        $create_edit='edit';
        $action_url=url('/kategori_produks') . '/' . $kategori_produk->id;
        $include_form='produks.kategori_produks.form_kategori_produk';
        return view('crud.open_record', compact('kategori_produk','title','create_edit','action_url','include_form'));
    }
