...
class UsersController extends Controller
{
    ...
    public function create()
    {
        $user = User::first();
        $divisi = Divisi::all();
        return view('otentikasis.users.create', compact('user', 'divisi'));
    }
    ...
    public function edit(User $user)
    {
        ...
        $divisi = Divisi::all();
        return view('otentikasis.users.edit', compact('user', 'divisi'));
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        User::where('id', $user->id)->update([
            ...
            'level' => $request->level,
            'is_disabled' => $request->is_disabled,
            'id_user_budget' => $request->id_user_budget
        ]);
