...
class ProjectAbsensisController extends Controller
{
    ...
    public function list_absen_kegiatan($project_kegiatan_id)
    {
        ...
        return view('projects.project_absensis.list_absen_kegiatan',compact('project_absensis'));
    }
    
    public function create()
    {
        $project_kegiatans=Project_kegiatan::all();
        $project_absensi=Project_absensi::limit(1)->get()->first();
        return view('projects.project_absensis.create', compact('project_absensi','project_kegiatans','lokasis'));
    } 
