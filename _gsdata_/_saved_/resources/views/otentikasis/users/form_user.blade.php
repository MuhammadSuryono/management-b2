...
@component('components.common_input', ['for_create_edit'=> $for_create_edit, 'detail_table'=>$user,'data_type'=>'text', 'label_width1'=>'3','label_width2'=>'6','input_width1'=>'6', 'input_width2'=>'6','input_label'=>'User', 'input_id'=>'user_login','other_option'=>$other_option])
@endcomponent
...
@if($for_create_edit == 'create' or ($for_create_edit == 'edit' and $user->user_login==session('user_login') ))
@component('components.common_input', ['for_create_edit'=> $for_create_edit, 'detail_table'=>$user,'data_type'=>'password', 'label_width1'=>'3','label_width2'=>'6','input_width1'=>'6', 'input_width2'=>'6','input_label'=>'Password', 'input_id'=>'password'])
@endcomponent
