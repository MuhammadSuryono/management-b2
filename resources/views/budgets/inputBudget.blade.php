...
<div class="row">
  ...
  <div class="col-sm-12">
    <div class="x_panel">
      <div class="x_title">
      {{-- <h2>{{$budget->nama}} - Div "{{$divisi->divisi}}"<small>Input Budget By Divisi</small></h2> --}}
      <h2>{{$budget->nama}} - {{$project->kode_project}} ({{$project->methodology}})</h2>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group row">
                <label class="col-form-label col-md-3 col-sm-3 ">Methodology : </label>
                <div class="col-md-9 col-sm-9 ">
                <input type="text" class="form-control" disabled="disabled" value="{{$project->methodology}}">
                </div>
            </div>
            <div class="form-group row">
      ...
      <div class="modal-content">
        ...
        <input type="hidden" name="id" id="id" value="{{$budget->noid}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9 col-sm-9 ">
                  <select class="form-control" name="divisibudget" id="divisibudget" required>
                    <option>Pilih Divisi</option>
                    <option value="RE B1">RE B1</option>
                    <option value="RE B2">RE B2</option>
                    <option value="Field MS">Field MS</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9 col-sm-9 ">
                  <select class="form-control" name="kota" id="kota" required>
                    ...
                    @foreach ($kota as $db)
                        <option value="{{$db->kota}}">{{$db->kota}}</option>
                    @endforeach
                  </select>
                </div>
              </div>
