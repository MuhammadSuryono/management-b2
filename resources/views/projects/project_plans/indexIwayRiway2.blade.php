                ...
                <table class="table table-hover" id="table">
                    <thead>
                        <tr>
                          ...
                          <th data-field="tgl" data-sortable="true">Tanggal Mulai</th>
                          <th data-field="tgl" data-sortable="true">Tanggal Selesai</th>
                      ...
                      <section id="urutan">
                        @foreach ($project_schedule as $db)
                            <tr id="{{$loop->iteration}}">
                              ...
                              <td>{{$db->tgl_selesai}}</td>
                              <td><button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target=".edit" data-id="{{$db->id}}" data-schedule="{{$db->nama_schedule}}" data-partisipan="{{$db->partisipan}}" data-tgl="{{$db->tgl_schedule}}" data-tglSelesai="{{$db->tgl_selesai}}"><i class="fa fa-edit"></i></button></td>
                            </tr>
...
<div class="modal fade bs-example-modal-lg tambah" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{route('project_plans.tambah2')}}" method="POST">
            <div class="modal-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9 col-sm-9 ">
                    <select class="form-control" name="nama" id="nama" required>
                      ...
                      @foreach ($newSchedule as $db)
                        <option value="{{$db->id}}">{{$db->task}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group row">
                    <label class="col-form-label col-md-3 col-sm-3 ">Tanggal Mulai : </label>
                    <div class="col-md-9 col-sm-9 ">
...
<div class="modal fade bs-example-modal-lg edit" tabindex="-1" role="dialog" aria-hidden="true" id="modalku">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form action="{{url('project_plans/simpanSchedule2')}}" method="POST">
        <div class="modal-body">
            @csrf
            ...
            <div class="form-group row">
                <label class="col-form-label col-md-3 col-sm-3 ">Tanggal Akhir : </label>
                <div class="col-md-9 col-sm-9 ">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#modalku').on('show.bs.modal', function (e) {
                ...
                modal.find("#tglSelesai").val(div.data('tglSelesai'));
            });
        });
